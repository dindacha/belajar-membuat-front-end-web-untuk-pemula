...
function addBook() {
  ...
  const book = inputBook(inputBookTitle, inputBookAuthor, inputBookYear, inputDibaca);
  const bookObject = composeBookObject(inputBookTitle, inputBookAuthor, inputBookYear, inputDibaca);
...
function inputBook(inputTitle, inputAuthor, inputYear, inputDibaca) {
...
function whiteButton() {
  ...
  return createButton("white-button", "Edit", function (event) {
...
function addBookToCompleted(taskElement) {
  ...
  const newBook = inputBook(book.title, book.author, book.year, (inputDibaca = true));
...
function editBook(taskElement) {
  ...
  submitEdit.addEventListener("click", function (event) {
    ...
    updateEditBook(editBookTitle.value, editBookAuthor.value, editBookYear.value, editDibaca.checked, book.id);
...
function updateEditBook(title, author, year, dibaca, id) {
...
function removeBook(taskElement) {
  const hapus = confirm("Menghapus buku?");
  if (hapus) {
